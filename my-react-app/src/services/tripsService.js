const BASE_URL = 'https://gruppe8.sccprak.netd.cs.tu-dresden.de/trips'; // proxy to real backend

export async function getTripById(tripId) {
  const res = await fetch(`https://gruppe8.sccprak.netd.cs.tu-dresden.de/trips/${tripId}`);
